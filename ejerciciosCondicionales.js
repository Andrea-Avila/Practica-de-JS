// //numeros primos son aquellos que solo son divisibles entre ellos mismos y el 1  por ejemplo si dividimos 12 que es un numero compuesto para llegar a el se puede dividir de varias formas como 2*2*3 

// //Le pide el numero al usuario
// let numeroEntero = prompt ("Por favor ingrese un numero entero");


// //Evaluamos los dos posible escenarios
// if (numeroEntero %1 ===0) { 

//     //Evaluamos los dos posibles escenarios; sea o mno primo (estado inicial de mis numeros)
//     let esNumeroPrimo =true;

// //Operacion para demostrar si es ono es primo
//     if (numeroEntero <=1) {
//         esNumeroPrimo =false; //demuestro que no es primo, y cambio el esatado inicial a falso
//     }else{
//         let =2;
//         while (i <= numeroEntero/2 && esNumeroPrimo) {
...
// } else console.log("por favor ingrese un número valido");
...
if (numeroIngresado <=1) {
    esNumeroPrimo = false; //demuestro que no es primo, y cambio el estado inicial a false
//Aqui solo hace una comparacion por si agregan un numero menor a 1 o el 1 que siempre va a ser un numero compuesto 
...
*/
    ...
    while (divisor <= numeroIngresado/2 && esNumeroPrimo){
        ...
        if (numeroIngresado % divisor === 0){
            esNumeroPrimo = false; //no es primo, es un numero compuesto
        }
...
//Recordemos que la condicional if es para arrojar que la condicon es verdadera
